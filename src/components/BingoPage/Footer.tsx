  ...
  return(
    <footer className="bg-[#BCF0FA] absolute bottom-0 w-screen flex flex-col md:flex-row items-start md:items-center justify-between px-12 py-8 gap-4">
      ...
      <div className="flex flex-wrap gap-3">
        <Button variant="secondary" onClick={() => window.open('https://apps.apple.com/kr/app/%EB%B9%99%ED%82%B7-bingket/id6761634987', '_blank')}>
          <div className="flex items-center justify-center gap-2">
            <Image src="/images/apple_logo.png" alt="" width={18} height={18} className="pb-1"/>
            앱스토어 다운로드
          </div>
        </Button>
        <Button variant="secondary" onClick={() => window.open('https://play.google.com/store/apps/details?id=com.day.bingket.app', '_blank')}>
          <div className="flex items-center justify-center gap-2">
